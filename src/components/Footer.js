        ...
        <footer className="bg-gray-900 text-white py-6">
            <div className="max-w-7xl px-4 sm:px-6 lg:px-8 mx-auto">
                <div className="flex flex-wrap justify-between items-center gap-5">
                    <div className="w-full md:w-1/4 text-center">
                        ...
                        <ul className="inline-flex space-x-4">
                            ...
                            <li>
                                <a href="https://twitter.com/Black_scorp_93" title="Twitter" target="_blank" className="block bg-blue-600 hover:bg-blue-700 p-1 rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="#ffffff" className="">
                            ...
                            <li>
                                <a href="https://www.linkedin.com/in/sakthi-dhasan-85b939288/" title="Linkedin" target="_blank" className="block bg-blue-600 hover:bg-blue-700 p-1 rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="#ffffff" className="">
                    ...
                    <div className="w-full md:w-1/4 text-center">
                        ...
                        <p className="text-sm mb-3">
                            <a href="mailto:sakthidhasan.velmurugan@gmail.com">sakthidhasan.velmurugan@gmail.com</a>
                        </p>
                    </div>
                    <div className="w-full md:w-1/4 text-center">
                ...
                <div className="flex justify-around gap-8 border-t border-gray-700 pt-4 mt-4 text-center text-sm">
                    ...
                    <div className="border-b border-gray-700 text-center text-sm">
                        Created with ❣️ by <a href="https://github.com/Black-venom-scorp-93" target="_blank" className="text-blue-400 hover:text-blue-500"> <span> Sakthi Dhasan</span></a>
                    </div>
                </div>
            </div>
        </footer>
